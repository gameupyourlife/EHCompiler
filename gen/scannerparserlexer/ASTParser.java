...
public class ASTParser extends Parser {
	...
	public static final int
		...
		T__45=46, T__46=47, T__47=48, T__48=49, T__49=50, IntegerLiteral=51, StringLiteral=52, 
		BooleanLiteral=53, CharacterLiteral=54, Identifier=55, WS=56, COMMENT=57, 
		LINE_COMMENT=58;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'class'", "'extends'", "'{'", "'}'", "'='", "';'", "'('", "')'", 
			"','", "'int'", "'boolean'", "'char'", "'void'", "'if'", "'else'", "'while'", 
			"'do'", "'for'", "'return'", "'break'", "'continue'", "'case'", "':'", 
			"'default'", "'.'", "'new'", "'++'", "'--'", "'+'", "'-'", "'!'", "'*'", 
			"'/'", "'%'", "'<='", "'>='", "'>'", "'<'", "'=='", "'!='", "'&&'", "'||'", 
			"'+='", "'-='", "'*='", "'/='", "'%='", "'this'", "'super'", "'null'"
		};
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, "IntegerLiteral", "StringLiteral", "BooleanLiteral", 
	...
	public final ClassBodyContext classBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 36028797018979328L) != 0)) {
				{
				setState(55);
				_errHandler.sync(this);
	...
	public final MethodDeclarationContext methodDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 36028797018979328L) != 0)) {
				{
				setState(71);
				formalParameters();
				}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 71776123293236424L) != 0)) {
				{
				{
				setState(99);
				statement();
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 71776123289075840L) != 0)) {
					{
					setState(142);
					expression(0);
					}
